...
def check_clickhouse():
    ...
    for ordinal in range(1, 4):
        ...
        try:
            count = peer.query("SELECT count() FROM clusterAllReplicas('fixture', system.one)").result_rows[0][0]
    ...
    replicas = client.query(
        ...
        "FROM clusterAllReplicas('fixture', system.replicas) WHERE database = 'analytics'"
    ).result_rows[0]
